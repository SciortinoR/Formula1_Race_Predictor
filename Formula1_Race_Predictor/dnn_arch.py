...
def form_dnn():
    ...
    dnn_model.add(Dense(128, activation='relu'))        # 128 neurons, using rectified linear activation function
    ...
    # Final output layer 
    dnn_model.add(Dense(34, activation='softmax'))      # 34 neurons for each final position class, softmax activation gives distributed probability/percentage for each class

    # Optimizer used in compilation/training
    # Learning rate is steps taken in gradient descent
